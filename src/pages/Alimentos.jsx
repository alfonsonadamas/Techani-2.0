...
export default function Alimentos() {
  ...
  const handleCheckboxPortion = (e,index) =>{
    ...
    const newCarbohydratesTotal = carbohydratetotal - selectedFood.carbohydratesall + (selectedFood.carbohydrates * newPortion);
  ...
  const handleCheckboxMeal = (e,record) =>{
    if(e.target.checked){
      ...
      setAlimentsSelect(alimentsSelect.filter(food =>food.id != record.idBancoAlimentos))
      setCarbohydratesTotal(carbohydratetotal-record.carbohydrates);
    }
  ...
  useEffect(() => {
    ...
    getMealTypes();
    getRecords();
  }, [alimentsSelect,carbohydratetotal]);
                          ...
                          <tr>
                            <td className='pr-4'>
                              <input 
                                ...
                                name="portion"
                                id="portion"
                                onChange={(e) => handleCheckboxMeal(e,record)}
                                checked={alimentsSelect.some(food => food.id === record.idBancoAlimentos)}
                              />
                            </td>
