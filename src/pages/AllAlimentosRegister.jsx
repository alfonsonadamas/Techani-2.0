...
export default function Comidas() {
  ...
  const validationSchema = Yup.object({
    foodName: Yup.string().matches(/^[^\d]+$/, "El campo debe ser texto").required("Este campo es requerido").max(10,"Minimo 10 caracteres"),
  ...
  return (
    <div>
      ...
      <div className="p-16 pt-20 sm:ml-64" data-aos="fade-up">
        {/*si el estado de enviado es falso muestre el formulario y si no que muestre un mensaje en pantalla*/}
