...
export default function Pagina1Registro() {
  const updateRegistro = async (
    { diabetesOption, ageOption },
    { setErrors, setSubmittin, resetForm }
  ) => {
    try {
      if (diabetesOption === "si") {
        ...
        window
          .open("", "_blank")
          .document.write("<h1>Este formulario no es para ti, gracias.</h1>");
      ...
      >
        {({ handleSubmit, handleChange }) => (
          <form onSubmit={handleSubmit}>
            <div
              className="bg-gray border-gray-700 w-fit shadow-lg flex flex-col items-center"
              style={{
            ...
            >
              <div
                ...
                style={{
                  ...
                  marginBlockStart: "110px",
                }}
              >
                <div style={{ margin: "30px" }}>
                  <div className="flex justify-between items-start h-10">
                    <b>
                      <h1 className="mt-6" style={{ fontSize: "22px" }}>
                        Hola
                      </h1>
                    </b>
                    <label
                  ...
                  <br />
                  <p className="mt-3 ">
                    Este proyecto web permite monitorear los niveles de glucosa
                    de pacientes con diabetes tipo 1 en tiempo real. Ofrece
                    gráficos y alertas personalizadas para el control eficaz de
                    la glucosa, facilitando la toma de decisiones médicas.
                    Mejora la calidad de vida y promueve un seguimiento continuo
                    y seguro.
                  </p>
                  <br />
                  <p>
                    Con el fin de ser de la mayor utilidad posible estamos
                    enfocados en monitoireo de la diabetes tipo 1.
                  </p>
                  <br />

                  <b>
                    <label>¿Tienes Diabetes tipo 1?</label>
                  </b>
                  <select
                    name="diabetesOption"
                    id="diabetesOption"
                  ...
                  <div className="flex justify-end ">
                    <button
                      type="submit"
                      className="font-light place-self text-white  mt-4 px-4 rounded-lg  hover:bg-blue-200 flex items-center justify-center"
                      style={{
                        backgroundColor: "#277BC0",
                        border: "1px ridge #13BAFF",
                      }}
                    >
