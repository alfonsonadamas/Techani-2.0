    ...
    <div>
      ...
      <div className="p-16 pt-16 sm:ml-64" data-aos="fade-up">
        <div className="mt-5">
          ...
          <div className="flex justify-evenly item flex-wrap mt-5">
            <div className="flex border-2 border-gray-200 hover:shadow-2xl transition-all duration-300 mb-10 rounded-lg w-2/5 h-52">
              ...
              <div className="w-1/2">
                ...
                <p className="text-justify mr-5 mb-4">
            ...
            <div className="flex border-2 border-gray-200 hover:shadow-2xl transition-all duration-300 rounded-lg w-2/5 h-52">
              <div className="w-1/2 flex justify-center items-center">
                <img
                  className="w-2/3 h-4/5 "
