          ...
          >
            ...
            >
              ...
              <div className="w-full hover:bg-gray-200 duration-300 rounded-md mt-1 ">
                <Link to={"/myaliments"} className="flex cursor-pointer p-2 ">
                  ...
                  <span className="ml-3">Ver Registros de Alimentos</span>
                </Link>
              </div>
              <div className="w-full hover:bg-gray-200 duration-300 rounded-md mt-1 ">
                <Link to={"/myfoods"} className="flex cursor-pointer p-2 ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
            ...
            <div className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-gray-100">
              ...
              <div
                ...
                onClick={dropDown5}
              >
                <span className="text-[15px] ml-2 font-semibold mr-3 whitespace-nowrap">
                  Estado de Ánimo
                </span>
                <span
                  className={
